                  ...
                  .map(
                    (participant) =>
                      `<li class="participant-item">
                        ...
                        <button type="button" class="delete-participant-button" data-activity="${escapeHtml(name)}" data-email="${escapeHtml(participant)}" aria-label="Remove ${escapeHtml(participant)}">🗑️</button>
                      </li>`
                  )
                  .join("")}
              </ul>
